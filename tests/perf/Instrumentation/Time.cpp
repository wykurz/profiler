...
BENCHMARK_DEFINE_F(TimeBenchFixture, RtdscTimeTest)(benchmark::State& state_) { timeTest<Rdtsc>(state_); }
BENCHMARK_REGISTER_F(TimeBenchFixture, RtdscTimeTest)->RangePair(1, 1, 1, 1 << 10);
